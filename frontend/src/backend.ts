...
import type { Announcement as _Announcement, SpiritualMessage as _SpiritualMessage, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addMassTiming(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMassTiming(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addMediaItem(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMediaItem(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addPrayer(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPrayer(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async countMassSchedule(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countMassSchedule();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async countMediaGallery(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countMediaGallery();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async countPrayers(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countPrayers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterPrayers(arg0: string): Promise<Array<Prayer>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterPrayers(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMassSchedule(): Promise<Array<MassTiming>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMassSchedule();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMediaGallery(): Promise<Array<MediaItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMediaGallery();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPrayersByLanguage(arg0: string): Promise<Array<Prayer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPrayersByLanguage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSpiritualMessage(): Promise<SpiritualMessage | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSpiritualMessage();
    ...
    async updateAnnouncement(arg0: string, arg1: bigint, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateSpiritualMessage(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSpiritualMessage(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SpiritualMessage]): SpiritualMessage | null {
    return value.length === 0 ? null : value[0];
}
